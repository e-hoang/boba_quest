...
private:
    ...
    const char ROOM = 'S';       // marker for room locations
    const char NPC = 'C';        // marker for NPC locations
    const char PARTY = 'X';      // marker for party position
    const char EXIT = 'E';       // marker for dungeon exit

    static const int num_rows_ = 10; // number of rows in map
    static const int num_cols_ = 10; // number of columns in map
